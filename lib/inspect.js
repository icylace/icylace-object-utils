 ...
 */
const inspect = (spec, obj) => Object.entries(spec).reduce((props, [key, value]) => {
  if (typeof value === "string") {
    props[value] = obj[key]
  } else if (value !== null && typeof obj[key] === "object") {
    props = Object.assign(props, inspect(value, obj[key]))
  }
  return props
}, {})
